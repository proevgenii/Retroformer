...
from utils.translate_utils import translate_batch_original, translate_batch_stepwise, translate_batch_accelerate
...
def translate(iterator, model, dataset):
    ...
    for batch in tqdm(iterator, total=len(iterator)):
        ...
        if args.stepwise == 'False':
            # Original Main:
            pred_tokens, pred_scores = translate_batch_accelerate(model, batch, beam_size=args.beam_size,
